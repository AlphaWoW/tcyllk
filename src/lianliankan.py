                ...
                for j1 in range(COLCNT):
                    for i2 in range(ROWCNT):
                        for j2 in range(COLCNT):
                            ...
                            if not (i1 == i2 and j1 == j2) and (game_box[i1][j1] > -1) and (game_box[i2][j2] > -1) and (game_box[i1][j1] != 38) and (game_box[i2][j2] != 38) and (game_box[i1][j1] == game_box[i2][j2]) and zfdfs.is_connected(game_box, i1, j1, i2, j2):
                                check_cnt += 1
